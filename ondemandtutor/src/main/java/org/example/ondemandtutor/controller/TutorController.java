...
public class TutorController {
    ...
    @PostMapping("/insert")
    ResponseEntity<ResponseObject> insertTutor(@RequestBody Tutor newTutor) {
    ...
    @PutMapping("/{id}")
    ResponseEntity<ResponseObject> updateTutor(@PathVariable long id, @RequestBody  Tutor newTutor) {
    ...
    //detele
    @DeleteMapping("/{id}")
    ResponseEntity<ResponseObject> deleteTutor(@PathVariable long id) {
